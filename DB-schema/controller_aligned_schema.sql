-- ========================================================================
-- EMRI ISSUE TRACKER - DATABASE SCHEMA (CONTROLLER-ALIGNED)
-- Complete schema matching all controller logic and operations
-- Generated from 41 Laravel Models + 33+ Controller Implementations
-- ========================================================================
...
-- Junction table for Vendor-State relationship (for Vendor Admin role scoping)
CREATE TABLE IF NOT EXISTS `map_vendor_state` (
    `vendor_state_id` BIGINT UNSIGNED NOT NULL AUTO_INCREMENT,
    `vendor_id` BIGINT UNSIGNED NOT NULL,
    `state_id` BIGINT UNSIGNED NOT NULL,
    
    PRIMARY KEY (`vendor_state_id`),
    KEY `fk_vs_vendor` (`vendor_id`),
    KEY `fk_vs_state` (`state_id`),
    UNIQUE KEY `uk_vendor_state` (`vendor_id`, `state_id`),
    
    CONSTRAINT `fk_vendor_state_vendor` 
        FOREIGN KEY (`vendor_id`) 
        REFERENCES `mst_vendor` (`vendor_id`)
        ON DELETE CASCADE ON UPDATE CASCADE,
    CONSTRAINT `fk_vendor_state_state` 
...
-- Role hierarchy for parent-child role relationships (used by UserMasterController)
CREATE TABLE IF NOT EXISTS `map_role_hierarchy` (
    ...
    KEY `fk_rh_parent` (`parent_role_id`),
    KEY `fk_rh_child` (`child_role_id`),
    ...
    CONSTRAINT `fk_role_hierarchy_parent` 
        ...
        ON DELETE CASCADE ON UPDATE CASCADE,
    CONSTRAINT `fk_role_hierarchy_child` 
...
-- User-State mapping for state-admin role scoping
CREATE TABLE IF NOT EXISTS `map_user_state` (
    `user_state_id` BIGINT UNSIGNED NOT NULL AUTO_INCREMENT,
    `user_id` BIGINT UNSIGNED NOT NULL,
    `state_id` BIGINT UNSIGNED NOT NULL,
    
    PRIMARY KEY (`user_state_id`),
    KEY `fk_us_user` (`user_id`),
    KEY `fk_us_state` (`state_id`),
    UNIQUE KEY `uk_user_state` (`user_id`, `state_id`),
    
    CONSTRAINT `fk_user_state_user` 
        FOREIGN KEY (`user_id`) 
        REFERENCES `mst_user` (`user_id`)
        ON DELETE CASCADE ON UPDATE CASCADE,
    CONSTRAINT `fk_user_state_state` 
        FOREIGN KEY (`state_id`) 
        REFERENCES `mst_state` (`state_id`)
        ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- User-SupportGroup mapping
CREATE TABLE IF NOT EXISTS `map_user_support_group` (
    `user_support_group_id` BIGINT UNSIGNED NOT NULL AUTO_INCREMENT,
    `user_id` BIGINT UNSIGNED NOT NULL,
    `support_group_id` BIGINT UNSIGNED NOT NULL,
    
    PRIMARY KEY (`user_support_group_id`),
    KEY `fk_usg_user` (`user_id`),
    KEY `fk_usg_group` (`support_group_id`),
    UNIQUE KEY `uk_user_support_group` (`user_id`, `support_group_id`),
    
    CONSTRAINT `fk_user_support_group_user` 
        FOREIGN KEY (`user_id`) 
        REFERENCES `mst_user` (`user_id`)
        ON DELETE CASCADE ON UPDATE CASCADE,
    CONSTRAINT `fk_user_support_group_group` 
...
-- SCHEMA SUMMARY
-- ========================================================================
-- Total Tables: 57 (added 5 new junction/hierarchy tables)
-- Master Tables: 23
-- Transaction Tables: 7
-- Configuration Tables: 7
-- Mapping/Junction Tables: 20 (includes role hierarchy & user mappings)
-- ========================================================================
