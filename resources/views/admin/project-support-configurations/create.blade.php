<x-app-layout>
    ...
    <x-slot name="header">
        <h2 class="text-xl font-semibold text-gray-800">
            Create Project Support Configuration
        </h2>
    </x-slot>
    ...
    <div class="py-8">
        ...
        <div class="mx-auto max-w-3xl px-4">
            ...
            <div class="rounded-3xl border border-slate-200 bg-white shadow-sm">
                ...
                <form method="POST" action="{{ route('project.support.store') }}" class="space-y-5 p-6">
                    ...
                    <div class="grid gap-5 md:grid-cols-2">
                        ...
                        <div>
                            ...
                            <input name="config_code" required value="{{ old('config_code') }}"
                        ...
                        <div>
                            ...
                            <input name="config_name" required value="{{ old('config_name') }}"
                    ...
                    <label class="flex items-center gap-2">
                        ...
                        <input type="checkbox" name="auto_routing_enabled" value="1" checked
